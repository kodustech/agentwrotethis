...
export const site = {
  ...
  description:
    'What changes in code review, testing and governance when agents write most of the code. Field notes, tool comparisons and what teams actually publish.',
  /** Footer line, the site in one sentence. */
  footerLine: 'Field notes on shipping software that agents mostly wrote.',
